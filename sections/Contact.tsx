...
export default function Contact() {
  return (
    <section id="contacto" className="relative py-40 px-6 bg-[#0F172A] text-white overflow-hidden rounded-t-[3rem]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-start">
        ...
        <a href="mailto:anderlfrias@gmail.com" className="bg-green-accent text-white px-8 py-4 rounded-full text-lg font-medium hover:brightness-90 transition-all flex items-center gap-3">
